...
public class RandomGUID {
  ...
  private void getRandomGUID(boolean secure) {
    ...
    try {
      ...
      throw new RuntimeException("MD5 algorithm not found! The gods must be crazy!");
    }
    ...
    try {
      ...
      // hash will always return 256 bits. You can change
      ...
      // logError("getRandomGUID error: " + e);
   ...
   * 
   * tharrisx - I've removed the dashes, cause why store and pass these
   * ms-imposed dashes around everywhere?
   */
  @Override
