 ...
 * classes that inherit from <code>java.text.DateFormat</code>. This difficulty
 * leads us to approach the problem using composition rather than inheritance.
 * In general classes that implement this interface will delegate these calls to
 * an internal DateFormat object.
 * </p>
 * 
 * @author tharrisx
 * @since 1.0.0
 * @version 1.0.0
 */
public interface SafeDateFormat {
